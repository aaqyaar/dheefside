...
export type BookedDemosResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["BookedDemos"] = ResolversParentTypes["BookedDemos"]
> = {
...
export type EnvelopeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Envelope"] = ResolversParentTypes["Envelope"]
> = {
...
> = {
  bookedDemos?: Resolver<
    ResolversTypes["ReturnData"],
    ParentType,
    ContextType,
    RequireFields<MutationBookedDemosArgs, "input">
  >;
  contact?: Resolver<
    ResolversTypes["ReturnData"],
    ParentType,
    ContextType,
    RequireFields<MutationContactArgs, "input">
  >;
  createService?: Resolver<
    ResolversTypes["Service"],
    ParentType,
    ContextType,
    Partial<MutationCreateServiceArgs>
  >;
  createTeam?: Resolver<
    ResolversTypes["Team"],
    ParentType,
  ...
  updateTeam?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateTeamArgs, "teamId">
  >;
};
...
> = {
  bookedDemos?: Resolver<
    Array<ResolversTypes["BookedDemos"]>,
    ParentType,
    ContextType
  >;
  service?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryServiceArgs, "serviceId">
  >;
  services?: Resolver<
...
> = {
  ...
  >;
  envelope?: Resolver<
    Maybe<ResolversTypes["Envelope"]>,
    ParentType,
    ContextType
  >;
  envelopeTime?: Resolver<
...
export type ReturnDataResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ReturnData"] = ResolversParentTypes["ReturnData"]
> = {
