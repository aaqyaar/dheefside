  ...
  return (
    <section className="pt-28">
      <div className="flex items-center justify-center flex-col">
        ...
        <h2 className="font-normal text-4xl capitalize py-2 text-gray-700">
      ...
      <div className={`bg-secondary ${styles.marginY} ${styles.paddingY}`}>
        <div
          className={`${styles.marginX} flex flex-col items-start justify-start `}
        >
          <h1
            className="
        ...
        "
          ...
          <p className="prose text-gray-200 text-xl py-4">
            <b className={`${styles.lightBold}`}>Protective partner.</b> From
            ...
            citizens worldwide.
            <b className={`${styles.lightBold}`}>
              A perfect blend of people and technology
            </b>{" "}
            We see business as a set of challenges and solutions. We don't like
            technology over the human mind. Instead, the right solution
            determines the right balance. For us, it takes the perfect mix of
            highly talented people, technology, and data to produce tremendously
            impressive results.{" "}
            <b className={`${styles.lightBold}`}>Visionary culture</b> Our
